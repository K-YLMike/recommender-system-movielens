#!/usr/bin/env python
"""Runner for the 'baseline_pop' stage -- point chain.sh / run_stage.sbatch here.

Compute the smoothed popularity baseline ranking (idempotent, CPU-ok).

This script runs the whole 'baseline_pop' stage (all seeds / variants). Every unit
...
Usage (from the project root):
    ...
    ./chain.sh run_stage.sbatch scripts/run_baseline_pop.py <num_jobs> <job_name>
"""
...
def main() -> None:
    ...
    pipeline.STAGES["baseline_pop"](cfg)
